...
const parentURL = 'https://kinnylee.github.io/';
...
function fileClosure(){ 
  ...
  (function() {
    ...
    utterances.setAttribute('repo','kinnylee/hugo-blog-comment')
    utterances.crossorigin = 'anonymous';
    utterances.src = 'https://utteranc.es/client.js';
    // content 是要插入评论的地方
    document.getElementById('post_content').appendChild(utterances);
    // document.getElementsByClassName('post_content')[0].appendChild(utterances);
  })();
